import 'bloc/k17_bloc.dart';
import 'models/k17_model.dart';
...
class K17Screen extends StatelessWidget {
  ...
  static Widget builder(BuildContext context) {
    return BlocProvider<K17Bloc>(
      create: (context) => K17Bloc(K17State(
        k17ModelObj: K17Model(),
      ))
        ..add(K17InitialEvent()),
      child: K17Screen(),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<K17Bloc, K17State>(
