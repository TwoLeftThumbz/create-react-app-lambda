import 'bloc/stat_one_bloc.dart';
import 'models/stat_one_model.dart';
...
class StatOneScreen extends StatelessWidget {
  const StatOneScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<StatOneBloc>(
      create: (context) => StatOneBloc(StatOneState(
        statOneModelObj: StatOneModel(),
      ))
        ..add(StatOneInitialEvent()),
      child: StatOneScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<StatOneBloc, StatOneState>(
