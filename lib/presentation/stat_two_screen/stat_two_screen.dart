import 'bloc/stat_two_bloc.dart';
import 'models/stat_two_model.dart';
...
class StatTwoScreen extends StatelessWidget {
  const StatTwoScreen({Key? key})
      : super(
          key: key,
        );

  static Widget builder(BuildContext context) {
    return BlocProvider<StatTwoBloc>(
      create: (context) => StatTwoBloc(StatTwoState(
        statTwoModelObj: StatTwoModel(),
      ))
        ..add(StatTwoInitialEvent()),
      child: StatTwoScreen(),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<StatTwoBloc, StatTwoState>(
